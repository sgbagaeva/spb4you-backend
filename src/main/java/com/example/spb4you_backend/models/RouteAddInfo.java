...
@Table("route_additional_info")
public class RouteAddInfo {
    @Id
    @JsonProperty("id")
    private Integer id;
    ...
    public boolean equals(Object o) {
        ...
        RouteAddInfo addInfo = (RouteAddInfo) o;
        return Objects.equals(this.id, addInfo.id) &&
                Objects.equals(this.routeId, addInfo.routeId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, routeId, title, description, sortOrder);
    }
